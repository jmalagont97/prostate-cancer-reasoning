"""exp_9: reveal-sequence with the ARD backbone, exp_8's expanded 23-column frame.

Identical to run_reveal_19col.py except the feature frame and psa_trend's group (includes
psav/psap here). See that script's docstring for shared design rationale.

Run with the project's own .venv (from the project root):
    .venv/Scripts/python.exe experiments/exp_9/scripts/run_reveal_23col.py
"""
...
def main() -> None:
    ...
    payload = {
        ...
        "note": "compare against exp_8's reveal_kdm_occlusion (scalar sigma, same frame): set_precision=0.799, macro_f1=0.531",
    }
