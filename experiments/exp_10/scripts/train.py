...
def main():
    exp_dir = project_root / "experiments" / "exp_10"
    ...
    # ---------------------------------------------------------
    # Phase A: Class-Weighted Meta-Threshold Learning (100 Splits)
    # ---------------------------------------------------------
    print("Beginning Phase A: 100 MCCV Splits Class-Weighted Meta-Threshold Learning...")
    ...
    for split_idx in range(100):
        ...
        # 3. Fit 1D DecisionTree WITH class_weight='balanced' on validation ICI vs confidence labels
    ...
    print(f"Learned Balanced Meta-Thresholds: bar_tau_1 = {bar_tau_1:.4f}, bar_tau_2 = {bar_tau_2:.4f}")

    # ---------------------------------------------------------
    # Phase B: Frozen LOOCV Evaluation (88 Folds)
    # ---------------------------------------------------------
    print("Beginning Phase B: Frozen LOOCV Evaluation across 88 folds...")
    ...
    plt.title("Distribution of Class-Weighted Decision Tree ICI Cut-Points (100 MCCV Splits)", fontsize=11, fontweight="bold")
    ...
    plt.title(f"LOOCV 3-Class Balanced Confidence Confusion Matrix (Macro-F1: {macro_f1:.4f})", fontsize=11, fontweight="bold")
    ...
    with open(summary_md_path, "w") as f:
        f.write("# Balanced Out-of-Fold Diagnostic Confidence Prediction (exp_10) Summary Report\n\n")
        f.write("**Date**: 2026-08-05  \n")
        f.write(f"**Model**: Class-Weighted Out-of-Fold ICI + Decision Tree Meta-Thresholding (MCCV $\\to$ LOOCV)  \n")
